...
Two charts, same three series (cantonal tax, communal tax, and the two
combined), restricted to the years where both tax series exist
(1990-2024) and, for chart 2, where GDP is also available (1997-2024):

1. taxes_per_capita_pct_median_salary.png -- the three series
...
2. taxes_per_capita_pct_pib.png -- the same three series expressed as a
...
The derived per-capita figures (including the plain CHF-per-inhabitant
one, which no longer has its own chart) are still written out as
...
# --- Chart 2: as a % of real GDP, 1997-2024 ---
